...
static void get_time(void) {
    clock_reg[0] = read_ds1307(0x04);
    clock_reg[1] = read_ds1307(0x05);
    clock_reg[2] = read_ds1307(0x06);
    clock_reg[3] = read_ds1307(0x02);
    clock_reg[4] = read_ds1307(0x01);
    clock_reg[5] = read_ds1307(0x00);
...
static void display_next_event(void)
{
    ...
    clcd_putch((alarms[index].hr / 10) + '0', (0xD0 + 7));
    clcd_putch((alarms[index].hr % 10) + '0', (0xD0 + 8));
    clcd_putch(':', (0xD0 + 9));
    clcd_putch((alarms[index].min / 10) + '0', (0xD0 + 10));
    clcd_putch((alarms[index].min % 10) + '0', (0xD0 + 11));
    clcd_putch((alarms[index].type), (0xD0 + 13));
}

void default_screen(void) {

    clcd_print("DATE: ", (0x80 + 0));
    get_time();
    clcd_putch(date[0], (0x80 + 6));
    clcd_putch(date[1], (0x80 + 7));
    clcd_putch('/', (0x80 + 8));
    clcd_putch(date[2], (0x80 + 9));
    clcd_putch(date[3], (0x80 + 10));
    clcd_putch('/', (0x80 + 11));
    clcd_putch(date[4], (0x80 + 12));
    clcd_putch(date[5], (0x80 + 13));
    clcd_putch(date[6], (0x80 + 14));
    clcd_putch(date[7], (0x80 + 15));


    clcd_print("TIME: ", (0xC0 + 0));
    clcd_putch(time[0], (0xC0 + 6));
    clcd_putch(time[1], (0xC0 + 7));
    clcd_putch(':', (0xC0 + 8));
    clcd_putch(time[2], (0xC0 + 9));
    clcd_putch(time[3], (0xC0 + 10));
    clcd_putch(':', (0xC0 + 11));
    clcd_putch(time[4], (0xC0 + 12));
    clcd_putch(time[5], (0xC0 + 13));

    noon = ((time[0] - '0') * 10) + (time[1] - '0');
    if (noon >= 12) {
        clcd_print("PM", (0xC0 + 14));
    } else {
        clcd_print("AM", (0xC0 + 14));
    }




    clcd_print("EVENT: ", (0xD0 + 0));
    display_next_event();
}
...
void display_config_menu(unsigned char key, unsigned char *screen_flag, unsigned char *reset_flag) {
    ...
    if (key == 0x3E && menu_pos < 1) {
        menu_pos++;
        clear_screen();
        return_time = 5;
    } else if (key == 0x3D && menu_pos > 0) {
        menu_pos--;
        clear_screen();
        return_time = 5;
    }
    ...
    clcd_print(menu[0], (0x80 + 2));
    clcd_print(menu[1], (0xC0 + 2));
...
static void save_time_date(void) {
    ...
    write_ds1307(0x04, dd);
    write_ds1307(0x05, mm);
    write_ds1307(0x06, yy);
...
void set_time_date(unsigned char *key, unsigned char *screen_flag, unsigned char *reset_flag) {
    ...
    if (*reset_flag == 0xF1) {
        ...
        *reset_flag = 0xF4;
        ...
        field = 0;
        blink_flag = 0;
        clcd_print("DD/MM/YYYY", (0x80 + 3));
        clcd_print("HH:MM:SS", (0x90 + 4));
    }
    ...
    if (*key == 0x3D) {
        ...
        save_time_date();
        clear_screen();
        clcd_print("Time / Date set", (0xC0 + 0));
        clcd_print("Successful", (0x90 + 0));
    ...
    if (field == 5) {
        clcd_putch((hr / 10) + '0', (0xD0 + 4));
        clcd_putch((hr % 10) + '0', (0xD0 + 5));
        clcd_putch(':', (0xD0 + 6));
        clcd_putch((min / 10) + '0', (0xD0 + 7));
        clcd_putch((min % 10) + '0', (0xD0 + 8));
        clcd_putch(':', (0xD0 + 9));

        if (--delay == 0) {
            delay = 5;
            if (blink_flag == 0) {
                clcd_putch((sec / 10) + '0', (0xD0 + 10));
                clcd_putch((sec % 10) + '0', (0xD0 + 11));
                blink_flag = 1;
            } else {
                clcd_print("  ", (0xD0 + 10));
                blink_flag = 0;
        ...
        clcd_putch((dd / 10) + '0', (0xC0 + 3));
        clcd_putch((dd % 10) + '0', (0xC0 + 4));
        clcd_putch('/', (0xC0 + 5));
        clcd_putch((mm / 10) + '0', (0xC0 + 6));
        ...
        if (--delay == 0) {
            delay = 5;
            if (blink_flag == 0) {
                clcd_print("20", (0xC0 + 9));
                clcd_putch((yy / 10) + '0', (0xC0 + 11));
                clcd_putch((yy % 10) + '0', (0xC0 + 12));
                blink_flag = 1;
            } else {
                clcd_print("    ", (0xC0 + 9));
                blink_flag = 0;
...
void add_edit_alarm(unsigned char *key, unsigned char *screen_flag, unsigned char *reset_flag) {
    ...
    if (field == 2) {
        clcd_putch((hr / 10) + '0', (0x90 + 2));
        clcd_putch((hr % 10) + '0', (0x90 + 3));
        clcd_putch(':', (0x90 + 4));
        clcd_putch((min / 10) + '0', (0x90 + 5));
        clcd_putch((min % 10) + '0', (0x90 + 6));

        if (--delay == 0) {
            delay = 5;
            if (blink_flag == 0) {
                clcd_putch(type, (0x90 + 8));
                blink_flag = 1;
            } else {
                clcd_putch(' ', (0x90 + 8));
                blink_flag = 0;
...
void set_view_alarm(unsigned char *key, unsigned char *screen_flag, unsigned char *reset_flag) {
    ...
    if (alarm_pos == alarm_count) {
        clcd_print("* Add Alarm", (0x80 + 0));
        clcd_print("                ", (0xC0 + 0));
    } else {
        clcd_print("* Alarm ", (0x80 + 0));
        clcd_putch((alarm_pos + 1) + '0', (0x80 + 8));

        clcd_putch((alarms[alarm_pos].hr / 10) + '0', (0xC0 + 2));
        clcd_putch((alarms[alarm_pos].hr % 10) + '0', (0xC0 + 3));
        clcd_putch(':', (0xC0 + 4));
        clcd_putch((alarms[alarm_pos].min / 10) + '0', (0xC0 + 5));
        clcd_putch((alarms[alarm_pos].min % 10) + '0', (0xC0 + 6));
        clcd_putch((alarms[alarm_pos].type), (0xC0 + 8));
    }
    ...
    if (*key == 0x3E) {
        ...
        *reset_flag = 0xF3;
        ...
        clear_screen();
        clcd_print("Alarm Deleted", (0x80 + 0));
